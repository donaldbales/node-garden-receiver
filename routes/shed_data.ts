...
import * as db from '../models/shed_data';
import * as logger from '../lib/logger';
import * as express from 'express';

const log: any = logger.instance;

const moduleName: string = 'routes/shed_data';

const router: Router = express.Router();

router.post('/shed_data', async function(req: Request, res: Response, next: NextFunction) {
